 ...
 * - les "places vides" (max_players - joueurs assignés) au prix de base
 * - les joueurs assignés mais qui n'ont pas encore payé
...
/**
 * Vérifie si le owner a au moins une réservation active (pending/confirmed)
 * avec un solde encore dû. Si oui, il ne peut pas créer de nouvelle réservation.
