...
function LoginForm() {
  ...
  const inputStyle = { width: '100%', background: '#1C2333', border: '1px solid #30363D', borderRadius: '8px', padding: '11px 14px', color: '#E6EDF3', fontSize: '15px', fontFamily: "'Inter', sans-serif", outline: 'none' }
    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px', background: '#0D1117' }}>
      <div style={{ width: '100%', maxWidth: '380px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <div style={{ fontFamily: "'Syne', sans-serif", fontSize: '18px', fontWeight: 800, color: '#4ADE80', letterSpacing: '2px' }}>MAYFAIR</div>
        ...
        <div style={{ background: '#161B22', border: '1px solid #30363D', borderRadius: '16px', padding: '28px' }}>
          <h1 style={{ fontFamily: "'Syne', sans-serif", fontSize: '20px', fontWeight: 700, marginBottom: '22px', textAlign: 'center', color: '#E6EDF3' }}>Connexion</h1>
          ...
          <button onClick={handleLogin} disabled={loading}
            style={{ width: '100%', background: '#4ADE80', color: '#0D1117', border: 'none', borderRadius: '8px', padding: '13px', fontSize: '15px', fontWeight: 700, cursor: 'pointer', fontFamily: "'Syne', sans-serif", opacity: loading ? 0.6 : 1, marginBottom: '14px' }}>
            {loading ? 'Connexion...' : 'Se connecter'}
          </button>

          <p style={{ fontSize: '13px', color: '#8B949E', textAlign: 'center' }}>
            Pas encore de compte ?{' '}
            <Link href="/register" style={{ color: '#4ADE80', textDecoration: 'none', fontWeight: 500 }}>Créer un compte</Link>
          </p>
        </div>
      </div>
    </div>
